...
function textTure(text, texture, fontSize, cWidth, cHeight, color, flip = true) {
    ...
    var numred = 0;
    var clearColor = new BABYLON.Color4(0, 0, 0, 0);
...
function placeObject(folder, file, position, scene, scale = 1, rotation = new BABYLON.Vector3(0, 0, 0), texture = new BABYLON.Color3(0.5, 0.5, 0.5)){
    ...
    var object = BABYLON.SceneLoader.ImportMesh(
        null,
         folder,
        file,
        scene,
        function (meshes) { 
           ...
           for (const mesh of meshes) { 
            ...
            var mat = new BABYLON.StandardMaterial("coke material", scene);
...
function threeDText(str, position, scene, rotation = new BABYLON.Vector3(0,0,0), fontSize = 0.3, cWidth = 3, cHeight = 5, scale = 1, maxWidth = 4) {
    ...
    var text = new Writer(
        ...
        {
            "anchor":  position,
            "varter-height": fontSize,
            "varter-thickness": fontSize / 2,
            "color": "#000080",

        }
    );

    //Text Writer create SPS with Particle for each varter
    var SPS = text.getSPS();
