...
var createScene = function () {
    ...
    function rooms() {
        ...
        //light
        var blue_pointlight = new BABYLON.PointLight("pointLight", new BABYLON.Vector3(14, 3.5, -10), scene);
        ...
        //camera
        camera.position = new BABYLON.Vector3(30, 6.5, -11);
        camera.setTarget(new BABYLON.Vector3(20, 4, -11));
        //objects
        let blue_table = placeObject('./models/Side_Table_04_OBJ/', 'Side_Table_04.obj', new BABYLON.Vector3(14, 0, -10), scene, scale = 0.065);
        let blue_coke = placeObject('./models/', 'Coca_Cola_Bottle_Turbosquid_2012.obj', new BABYLON.Vector3(14, 3.5, -10), scene, 0.1, new BABYLON.Vector3(0, 0, 0), new BABYLON.Color3(0, 0, 1));
        //END BLUE COKE ROOM
        ...
        pointlight.intensity = 0.5;
        //camera
        camera.position = new BABYLON.Vector3(26, 7, -15);
        camera.setTarget(new BABYLON.Vector3(29, 3, 0));
        //objects
        let rack = placeObject('./models/clothes_rack_with_hangers/', 
        'clothes rack with hangers obj.obj', new BABYLON.Vector3(23, 0, -5), scene, 0.0065, 
        new BABYLON.Vector3(0, Math.PI/2, 0), new BABYLON.Color3(0.2, 0.2, 0.2));
        ...
        //masculinity room
        // camera.position = new BABYLON.Vector3(30, 8, 0);
